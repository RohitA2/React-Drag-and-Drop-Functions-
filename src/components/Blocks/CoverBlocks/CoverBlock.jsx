...
const CoverBlock = ({
  ...
  // Function to determine background style (kept as inline for dynamic values)
  const getBackgroundStyle = () => {
    const {
      backgroundImage,
      backgroundGradient,
    ...
    >
      ...
      >
        ...
        <div className="mx-auto relative z-2 w-[72%] max-w-[980px]">
          <div className="rounded-xl bg-white/5 border border-white/10 px-[22px] py-[18px] text-[#f3c6ff] backdrop-blur-[2px]">
