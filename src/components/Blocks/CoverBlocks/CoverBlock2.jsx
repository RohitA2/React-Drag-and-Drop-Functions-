...
//     backgroundImage: "images/people2.avif",
...
const CoverBlock = ({
  ...
  const defaultSettings = {
    backgroundColor: "#401C47",
    backgroundImage: "/images/people2.avif", // Added leading / for public folder assets (common Vite fix)
    backgroundGradient: null,
    backgroundVideo: null,
    filter: "none",
    position: 50,
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Content area - simplified for heading/title style (centered, no quote box) */}
        <div className="mx-auto relative z-2 w-[85%] max-w-[980px] text-center">
          <EditableQuill
            id="cover-title"
            value={content}
            onChange={setContent}
            ...
            style={{
              color: "#f3c6ff",
              textShadow: "0 4px 12px rgba(0,0,0,0.6)", // Improved readability on images
            }}
          />
        </div>
