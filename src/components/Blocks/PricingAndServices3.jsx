...
const PricingAndServices3 = ({ isPreview = false, blockId, parentId }) => {
  ...
  const itemTotals = useMemo(
    ...
    [items, globalVatRate, globalVatType, globalRutDiscount, globalRotRate, globalEnvTaxRate]
  );
  ...
  const rounding = 0;
  const grandTotal = netTotal + vatTotal + rotTotal + envTaxTotal + rounding - rutDiscountTotal;
                ...
                <div className="px-2 py-3 space-y-4">
                  ...
                  <Form.Group>
                    ...
                    <Form.Control
                      ...
                      value={globalRotRate}
                      onChange={(e) =>
                        setGlobalRotRate(parseFloat(e.target.value))
                      }
                      min="0"
                      step="0.1"
                      size="sm"
            ...
            {items[currentItemIndex] && (
              <Form>
                <div className="row g-3">
                  ...
                  <div className="col-md-4">
                    <Form.Group>
                      <Form.Label className="fw-semibold small">ROT Rate (%)</Form.Label>
                      <Form.Control
                        type="number"
                        min="0"
                        max="100"
                        step="0.1"
                        value={items[currentItemIndex].rotRate || globalRotRate}
                        onChange={(e) =>
                          updateItem(
                            currentItemIndex,
                            "rotRate",
                      ...
                      <div className="row small text-gray-700">
                        ...
                        <div className="col-md-3 mb-1">
                          ...
                          <div className="fw-semibold text-warning">
                            {currency.symbol}{" "}
                            {calculateItemTotals(items[currentItemIndex]).rotAmount.toFixed(2)}
                          </div>
                        </div>
                        <div className="col-md-3 mb-1">
                          <div>Env Tax:</div>
