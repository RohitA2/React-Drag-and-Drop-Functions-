...
//   Fingerprint,
//   ArrowRight,
//   PersonCheck,   // Correct: was UserCheck
//   Lock,
//   Stars,         // Valid icon
...
// // ... [addCaptureMask, renderProposalToPdfBlob, normalizeNin] remain unchanged
...
//         if (pdfBlob.size > 8 * 1024 * 1024) {
//           toast.error("Document too large (>8MB). Simplify content.");
//           return;
//         }
//       }
...
//       const res = await axios.post(`${API_URL}/api/signicat/create-session`, fd, {
//         timeout: 60000,
//         headers: { Accept: "application/json" },
//       });

//       if (res?.data?.success && res?.data?.signUrl) {
//         toast.success("Redirecting to Signicat...");
...
//     } catch (err) {
//       console.error(err);
//       toast.error(err?.response?.data?.message || err.message || "Failed to prepare document.");
//     } finally {
//       undoMask();
//       setIsLoading(false);
//     }
